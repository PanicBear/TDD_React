...
describe('Habit Tracker', () => {
  ...
  it('decreases count', () => {
    ...
    cy.findAllByTestId('habit-count').first().should('have.text', '3');
  });
  ...
  it('reset to 0 when clicking reset all', () => {
    ...
    cy.findAllByTestId('habit-count').each((item) => cy.wrap(item).should('have.text', '0'));
